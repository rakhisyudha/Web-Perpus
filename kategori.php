...
if (isset($_GET['hapus'])) {
    ...
    echo "<script>document.location.href='?kategori';</script>";
}
?>
<div class="col-lg-12">
    <div class="card mb-0">
        <div class="card-header">
            ...
            <h3 class="h4 mb-0">Data Buku dan Kategorinya</h3>
            <br><a href="dashboard.php?abuku"><button class="btn btn-primary" type="button"> Tambah Kategori dan Buku </button></a>
